...
class ModelV1:
    '''
    Same as model V0 but with even weights on the main and auxiliary outputs.
    '''
    _embeddings = {
    ...
    def __init__(self,
        ...
        self.embeddings_path = _embeddings[word_embedding_dims]
    ...
    def build_model(self):
        ...
        merged = concatenate(
            [title_pooling, hour_reshape, weekday_reshape, minute_reshape, date_reshape])
